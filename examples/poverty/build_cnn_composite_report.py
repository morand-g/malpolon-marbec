...
ROOT = Path(
    ...
    "outputs/Madagascar_Composite_Pretrain_Canonical"
)

OUT_OOF = ROOT / "cnn_composite_pretrain_oof_enriched.csv"
OUT_REPORT = ROOT / "cnn_composite__pretrain_benchmark_report.csv"

MODEL_NAME = "CNN composite pretrain"
N_FOLDS = 5
EXPECTED_N = 2290
...
def main():
    ...
    print("Building CNN Composite benchmark report...\n")
