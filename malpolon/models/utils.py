...
from .custom_loss import FilteredHuberLoss, LogSpacingLoss, ModifiedCELoss, CeSrLoss, FilteredMSELoss, SumMSELoss, ClassifMSELoss, ZeroWeightedMSELoss
...
def check_loss(loss: Union[nn.modules.loss._Loss, str],
               loss_kwargs: Mapping = {}) -> nn.modules.loss._Loss:
    ...
    if isinstance(loss, nn.modules.loss._Loss):  # pylint: disable=protected-access  # noqa
        ...
        if loss in LOSS_CALLABLES:
            return LOSS_CALLABLES[loss](**loss_kwargs)
